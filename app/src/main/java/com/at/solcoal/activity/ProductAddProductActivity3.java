...
public class ProductAddProductActivity3 extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if(sharedpreferences!= null) {
			...
			if(userIdStr == null) {
				Intent intent = new Intent(ProductAddProductActivity3.this, SigninActivity.class);
				intent.putExtra(AppConstant.ADD_EDIT, AppConstant.ADD);
				startActivity(intent);
			}
		}

		context = ProductAddProductActivity3.this;
		activity = ProductAddProductActivity3.this;
	...
	{
		Intent intent = new Intent(ProductAddProductActivity3.this, Congratulations.class);
		ProductAddProductActivity3.this.finish();
		startActivity(intent);
	...
	{
		Intent intent = new Intent(ProductAddProductActivity3.this, GoogleMapActivity.class);
		intent.putExtra("lat", "");
	...
	private void add_pic()
	{
		((LinearLayout) findViewById(R.id.add_more_picture)).setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event)
			{
				...
				{
					startActivity(new Intent(ProductAddProductActivity3.this, ProductAddPictureActivity.class));
					ANIM.onStartActivity(activity);
					v.setPressed(false);
	...
	private void addImageToHSV(String filePath, String type)
	{
		...
		if (type.equals(AppConstant.WEB))
		{
			...
			SmartImageView image = (SmartImageView) view.findViewById(R.id.image);
			{
				...
				try
				{
					Picasso.with(ProductAddProductActivity3.this).load(Uri.parse(filePath)).rotate(rotation).noFade()
		...
		} else if (!(type.equals(AppConstant.Gallery2) && ((new File(filePath)).length() <= 0L)))
		{
			...
			SmartImageView image = (SmartImageView) view.findViewById(R.id.image);
			{
				...
				try
				{
					...
					Picasso.with(ProductAddProductActivity3.this).load(Uri.fromFile(new File(filePath))).rotate(rotation)
...
//					UI(Add_Edit);  // compress image
	...
	private void showCategoryList()
	{
		...
		listPopupWindow = new ListPopupWindow(ProductAddProductActivity3.this);
		listPopupWindow.setAdapter(new ArrayAdapter(ProductAddProductActivity3.this, R.layout.list_item, products));
	...
	private void showSubCategoryList(final String cat)
	{
		...
		listPopupWindow2 = new ListPopupWindow(ProductAddProductActivity3.this);
		listPopupWindow2.setAdapter(new ArrayAdapter(ProductAddProductActivity3.this, R.layout.list_item, products));
...
//				reqParam.put("image_data", new FileInputStream(myFile), myFile.getName());
				...
				reqParam.put("image_data", IMAGE_UTIL.getFileInputStream(context, filePath), IMAGE_UTIL.getfileNameFromPath(filePath));
	...
	{
//		Intent intent = new Intent(ProductAddProductActivity.this, ProductListPage.class);
