...
import com.at.drgrep.adapter.MyRecyclerAdapter;
    ...
    private void fetchShopList(String userIdStr)
    {
        ...
        asyncWebClient.post(reqParam, new JsonHttpResponseHandler() {
                    ...
                    if (responseCode.equals("1")) {
                        ...
                        if (l > 0) {
                            ...
                            if (feedsList.size() > 0) {
                                ...
                                com.at.drgrep.utility.Toast.showSmallToast(getContext(), "No Data found.");
                            }
                        } else {
                            com.at.drgrep.utility.Toast.showSmallToast(getContext(), "No Data found.");
                        }
                    } else {
                        com.at.drgrep.utility.Toast.showSmallToast(getContext(), "Error!!!");
            ...
            public void onFailure(int statusCode, org.apache.http.Header[] headers, String responseString,
                ...
                //progressDialog.dismiss();
                com.at.drgrep.utility.Toast.showNetworkErrorMsgToast(getContext());
            }
