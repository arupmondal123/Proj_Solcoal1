...
public class GeoAutoCompleteAdapter2 extends BaseAdapter implements Filterable
{
	...
	public GeoAutoCompleteAdapter2(Context context)
	{
		mContext = context;
	}
...
//		((TextView) convertView.findViewById(R.id.geo_search_result_text)).setText(getItem(position).getAddressStr());
