...
import com.at.drgrep.adapter.GridViewAdapterProduct;
import com.at.drgrep.animation.ANIM;
import com.at.drgrep.constants.AppConstant;
import com.at.drgrep.data.GridViewAdapterProductData;
...
import com.at.drgrep.sharedpref.SharedPref;
import com.at.drgrep.utility.IMAGE_UTIL;
import com.at.drgrep.utility.NI;
import com.at.drgrep.utility.Network;
import com.at.drgrep.utility.ScrollableSwipeRefreshLayout;
import com.at.drgrep.utility.SessionManager;
...
import static com.at.drgrep.activity.UserProfileActivity.toCamelCase;
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.share:
                ...
                sAux = sAux + "https://play.google.com/store/apps/details?id=com.at.drgrep&hl=en \n\n";
            ...
            case R.id.myShop:
                ...
                intent2.putExtra("fromactivity","ProductListActivity");
...
//		productGridViewAdapter = new GridViewAdapterProduct(activity, imageWidth);
	...
	*/
    ...
    private void InitializeGridLayout() {
        ...
        int GRID_PADDING1 = 5; // Gridview image padding in dp
        int GRID_PADDING2 = 5; // Gridview image padding in dp
    ...
    private void browseUserProduct() {
        ...
        intent.putExtra("fromactivity","ProductListActivity");
